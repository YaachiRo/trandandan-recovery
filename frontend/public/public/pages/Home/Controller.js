...
const friendsData = [
    ...
    },
    {
      id: 2,
      name: "Bob",
      photoUrl: "/public/assets/cat.png",
      status: "offline"
    },
    {
      id: 3,
      name: "Charlie",
      photoUrl: "/public/assets/rabbit.png",
      status: "in-queue"
    },
    {
      id: 4,
      name: "Dana",
      photoUrl: "/public/assets/fox.png",
      status: "in-game"
    },
    {
      id: 5,
      name: "Evan",
      photoUrl: "/public/assets/parrot.png",
      status: "online"
    }
  ];
...
export default  () => {
    ...
    var status = false; // get the status from the backend but for now lets set it to false for first login
    tournament_btn.addEventListener("click", function()
    {
        if (!status)
        {
            // tournament registration logic after backend handle it
